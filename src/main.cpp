...
#endif
{
    ...
    while(running)
    {
        ...
        while(SDL_PollEvent(&e))
        {
            ...
            window.handleZoomEvent(e);
            window.handleColorEvent(e);
            window.handleCameraMovementEvent(e);
            //window.handleObjectTranslationEvent(e);
            window.handleObjectRotationEvent(e);
            window.handleObjectScaleEvent(e);
            window.addExtraObject(e);
            window.handleLightPositionEvent(e);
            window.handleTextureChangeEvent(e);
